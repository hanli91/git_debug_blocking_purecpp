...
void new_topk_sim_join_reuse_impl(const Table& ltoken_vector, const Table& rtoken_vector,
                                  ...
                                  Heap& topk_heap, vector<TopPair>& init_topk_list, CandSet& cand_set,
...
Heap new_topk_sim_join_reuse(const Table& ltoken_vector, const Table& rtoken_vector,
    ...
    Heap topk_heap;
    new_topk_sim_join_reuse_impl(ltoken_vector, rtoken_vector, max_field_num, use_remain,
                                 remained_fields, removed_fields,
                                 prefix_events, topk_heap, init_topk_list,
